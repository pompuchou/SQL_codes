...
from	al.dbo.tbl_pijia as A
	left outer join
		al.dbo.tbl_opd_order as B
	on A.CASENO=B.CASENO
where	A.G=1 and CLASS='藥品' and B.rid in ('EMYCO','SCHLO','OSERO100') and A.SDATE between '20181001' and '20181031'
...
from	al.dbo.tbl_pijia as A
	left outer join
		al.dbo.tbl_opd_order as B
	on A.CASENO=B.CASENO
where	A.G=1 and CLASS='藥品' and B.rid in ('ODEPATEC5','ODOGM200','OAMARM','OPKMERZ','SALPHA','ODOXA4') and A.SDATE between '20180901' and '20180930'
order by A.SDATE
...
from	al.dbo.tbl_pijia as A
	left outer join
		al.dbo.tbl_opd_order as B
	on A.CASENO=B.CASENO
where	A.G=1 and CLASS='藥品' and A.CASENO in ('AC180918101028','AC180918101039','AC180927101043','AC180927101026','AC180927101011','AC180927101027') and A.SDATE between '20180901' and '20180930'
